...
WSGI_APPLICATION = 'django_msat.wsgi.application'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = 'admin@mail.accountabilityconsole.com'
SERVER_EMAIL = 'server@mail.accountabilityconsole.com'
